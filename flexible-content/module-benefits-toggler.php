        ...
        <div class="u-cols<?php if($image) : ?> has-image<?php endif; ?>">
            <?php if($image) : ?>
                <div class="u-col u-col--left">
                    <?php get_image($image, 'original-600'); ?>
                </div>
            <?php endif; ?>

            <div class="u-col u-col--right">
                <div class="c-togglers">
                    <?php $countTogglers = 0; foreach($content['togglers'] as $item) : $countTogglers++; ?>
                        <div class="c-toggler <?php echo $countTogglers === 1 ? 'is-active': ''; ?>">
                            ...
                            <div class="c-toggler__content" <?php echo $countTogglers === 1 ? 'style="display: block;"': ''; ?>>
                                <div class="c-editor">
                                    <?php echo $item['text']; ?>
                                </div>
                            </div>
