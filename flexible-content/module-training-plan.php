    ...
    <?php if($feed === 'individual') : ?>
        <div class="c-plan">
            ...
            <div class="c-plan-body">
                <div class="container">
                    <?php foreach($options['subscription'] as $option) : ?>
                    <div class="c-plan-content is-single" id="<?php echo $post->post_name; ?>-<?php echo $option['price']; ?>">
                        <div class="u-cols fx">
    ...
    <?php if($feed === 'all') : ?>
        ...
        <div class="c-plan">
            <header class="c-plan-header">
                <div class="container">
                    <div class="c-nav">
                        <a href="#3-luni" class="c-nav__item">3 Luni</a>
                        <a href="#6-luni" class="c-nav__item">6 Luni</a>
                        <a href="#12-luni" class="c-nav__item">12 Luni</a>
                    </div>

                    <div class="c-nav c-nav--coaches">
                        <?php  while ( $loop->have_posts() ) : $loop->the_post(); ?>
                            <a href="#<?php echo $post->post_name; ?>" class="c-nav__item"><?php echo get_the_title(); ?></a>
            ...
            <div class="c-plan-body">
                <div class="container">
                    ...
                    <?php foreach($options['subscription'] as $option) : ?>
                    <div class="c-plan-content has-multiple" id="<?php echo $post->post_name; ?>-<?php echo $option['price']; ?>">
                        <div class="u-cols fx">
                            <div class="u-col u-col--left">
                                <div class="c-plan__image">
                                    <?php if($post->post_type === 'antrenori') : ?>
